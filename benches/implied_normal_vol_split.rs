...
define_case_benches!(
    ...
    atm_call_cpp_direct,
    support::normal_implied_case(support::ATM_CALL)
);
...
define_case_benches!(
    ...
    support::normal_implied_case(support::DEEP_ITM_PUT_LONG)
);
...
define_case_benches!(
    ...
    support::normal_implied_case(support::DEEP_OTM_CALL_LONG)
);
...
define_case_benches!(
    ...
    support::normal_implied_case(support::NEAR_ATM_CALL_SHORT)
);
...
define_case_benches!(
    ...
    support::normal_implied_case(support::EDGE_ZERO_EXPIRY_CALL)
);
