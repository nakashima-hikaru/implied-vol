...
fn householder3_factor(v: f64, h2: f64, h3: f64) -> f64 {
    (1.0 + 0.5 * h2 * v) / (1.0 + v * (h2 + h3 * v / 6.0))
}

#[inline(always)]
fn householder4_factor(v: f64, h2: f64, h3: f64, h4: f64) -> f64 {
    (1.0 + v * (h2 + v * h3 / 6.0))
        / (1.0 + v * (1.5 * h2 + v * (h2 * h2 / 4.0 + h3 / 3.0 + v * h4 / 24.0)))
}
...
fn y_prime_tail_expansion_rational_function_part(w: f64) -> f64 {
    w * (-2.999_999_999_999_466
        + w * (-1.755_626_332_354_220_6E2
            + w * (-3.473_503_544_549_563_2E3
                + w * (-2.780_574_569_386_430_8E4
                    + w * (-8.383_602_146_074_198E4 - 6.681_824_903_261_685E4 * w)))))
        / (1.0
            + w * (6.352_087_774_483_173_6E1
                + w * (1.440_438_903_760_433_7E3
                    + w * (1.456_254_563_850_703_4E4
                        + w * (6.688_679_416_565_168E4
                            + w * (1.256_997_038_092_390_9E5 + 6.928_651_867_980_375E4 * w))))))
}
...
fn y_prime(h: f64) -> f64 {
    ...
    if h < -4.0 {
        ...
        (1.000_000_000_059_431_8
            - h * (6.191_144_987_969_411E-1
                - h * (2.218_084_473_657_601_4E-1
                    - h * (4.565_090_035_135_299E-2
                        - h * (5.545_521_007_735_379_5E-3
                            - h * (3.071_739_227_491_390_3E-4
                                - h * (4.276_659_783_590_871_4E-8
                                    + 8.459_243_640_658_06E-10 * h)))))))
            / (1.0
                - h * (1.872_428_636_958_916_3
                    - h * (1.568_549_723_607_765_2
                        - h * (7.657_648_983_658_903E-1
                            - h * (2.367_770_140_309_464E-1
                                - h * (4.676_254_890_319_496E-2
                                    - h * (5.529_045_357_693_659E-3
                                        - 3.082_202_041_792_714_7E-4 * h)))))))
    } else {
...
fn small_t_expansion_of_scaled_normalised_black(h: f64, t: f64) -> f64 {
    ...
    fn b2(a: f64, h2: f64) -> f64 {
        (-7.0 - h2 + a * (15.0 + h2 * (10.0 + h2))) / 60.0
    }
    #[inline(always)]
    fn b3(a: f64, h2: f64) -> f64 {
        (-57.0 + (-18.0 - h2) * h2 + a * (105.0 + h2 * (105.0 + h2 * (21.0 + h2)))) / 2520.0
    }
    #[inline(always)]
    ...
    t * (b0(a)
        + t2 * (b1(a, h2)
            + t2 * (b2(a, h2)
                + t2 * (b3(a, h2) + t2 * (b4(a, h2) + t2 * (b5(a, h2) + b6(a, h2) * t2))))))
}
...
fn b_u_over_b_max(s_c: f64) -> f64 {
    if s_c >= 2.449_489_742_783_178 {
        let y = s_c.recip();
        let g = (-4.605_394_817_212_609E-2
            + y * (1.375_163_082_077_259_1
                + y * (1.455_319_886_249_397_7E1
                    + y * (8.488_089_220_080_239E1
                        + y * (2.983_680_162_805_663E2
                            + y * (6.169_692_835_129_17E2
                                + y * (6.589_280_957_677_407E2 - 1.229_189_712_271_654_4 * y)))))))
            / (1.0
                + y * (9.327_034_903_790_405
                    + y * (5.436_378_146_588_073E1
                        + y * (2.030_420_459_952_177_3E2
                            + y * (5.079_647_179_123_228E2
                                + y * (8.698_830_313_690_185E2
                                    + y * (8.881_238_333_960_678E2
                                        + 5.206_084_752_279_256E2 * y)))))));
        0.894_954_297_278_031_3 + 0.113_984_531_941_499_06 * y * (-1.253_314_137_315_500_3 + y * g)
    } else {
        let g = (-6.063_099_880_334_851E-2
            + s_c
                * (-1.344_864_378_589_371E-1
                    + s_c
                        * (-1.416_368_116_424_721E-1
                            + s_c
                                * (-8.976_383_086_137_545E-2
                                    + s_c
                                        * (-3.512_133_741_041_69E-2
                                            + s_c
                                                * (-8.143_812_878_548_491E-3
                                                    + s_c
                                                        * (-8.733_991_026_156_887E-4
                                                            - 3.386_756_817_001_176_5E-9
                                                                * s_c)))))))
            / (1.0
                + s_c
                    * (2.722_003_340_655_505_5
                        + s_c
                            * (3.650_335_036_015_884_6
                                + s_c
                                    * (3.018_638_953_766_389_6
                                        + s_c
                                            * (1.652_734_794_196_848_7
                                                + s_c
                                                    * (5.959_161_649_351_221E-1
                                                        + s_c
                                                            * (1.324_801_623_892_073E-1
                                                                + 1.421_206_743_529_177_8E-2
                                                                    * s_c)))))));
...
fn b_l_over_b_max(s_c: f64) -> f64 {
    if s_c < 0.7099295739719539 {
        let g = (8.074_107_237_288_286E-2
            + s_c
                * (9.807_891_178_635_89E-2
                    + s_c
                        * (3.976_063_144_567_705_5E-2
                            + s_c
                                * (5.971_692_845_958_919E-3
                                    + s_c
                                        * (-6.403_639_934_147_98E-6
                                            + 4.542_510_209_361_606_4E-7 * s_c)))))
            / (1.0
                + s_c
                    * (1.859_497_767_228_766_5
                        + s_c
                            * (1.365_880_147_571_179
                                + s_c
                                    * (4.613_270_710_865_565E-1
                                        + 6.125_459_704_983_172E-2 * s_c))));
        (s_c * s_c) * (0.075_609_966_402_963_62 + s_c * (s_c * g - 0.096_727_192_813_394_37))
    } else if s_c < 2.6267851073127395 {
        (1.979_573_792_759_858E-9
            + s_c
                * (-2.708_128_856_468_558_7E-8
                    + s_c
                        * (7.561_014_227_254_904E-2
                            + s_c
                                * (6.917_130_174_466_835E-2
                                    + s_c
                                        * (2.953_705_895_096_301_8E-2
                                            + s_c
                                                * (6.584_925_270_230_231E-3
                                                    + 6.971_140_063_983_471E-4 * s_c))))))
            / (1.0
                + s_c
                    * (2.194_144_852_558_658
                        + s_c
                            * (2.129_710_354_999_518
                                + s_c
                                    * (1.157_148_318_717_978_3
                                        + s_c
                                            * (3.783_162_225_306_046E-1
                                                + s_c
                                                    * (7.171_486_244_882_935E-2
                                                        + 6.636_197_582_786_12E-3 * s_c))))))
    } else if s_c < 7.348469228349534 {
        (-9.332_511_535_483_788E-5
            + s_c
                * (5.311_803_397_279_465E-4
                    + s_c
                        * (7.411_485_544_834_501E-2
                            + s_c
                                * (7.403_965_818_682_282E-2
                                    + s_c
                                        * (3.922_517_740_768_760_6E-2
                                            + s_c
                                                * (1.002_291_337_825_409E-2
                                                    + 1.701_257_940_724_605_5E-3 * s_c))))))
            / (1.0
                + s_c
                    * (2.221_723_813_222_813_4
                        + s_c
                            * (2.344_181_670_708_740_4
                                + s_c
                                    * (1.391_232_364_627_114
                                        + s_c
                                            * (5.323_125_844_350_184E-1
                                                + s_c
                                                    * (1.174_400_591_971_610_1E-1
                                                        + 1.619_540_589_593_093_7E-2 * s_c))))))
    } else {
        (1.450_007_229_724_060_4E-3
            + s_c
                * (-1.511_669_248_501_119_6E-3
                    + s_c
                        * (7.168_217_831_093_633E-2
                            + s_c
                                * (3.921_610_857_820_463_6E-2
                                    + s_c
                                        * (2.934_240_565_862_844_5E-2
                                            + s_c
                                                * (5.183_252_617_163_152E-3
                                                    + 1.693_020_807_842_147_5E-3 * s_c))))))
            / (1.0
                + s_c
                    * (1.617_631_350_230_541_5
                        + s_c
                            * (1.682_315_917_528_153_2
                                + s_c
                                    * (8.487_830_756_737_222E-1
                                        + s_c
                                            * (3.754_374_213_737_579E-1
                                                + s_c
                                                    * (7.126_137_099_644_303E-2
                                                        + 1.611_699_254_678_867_7E-2 * s_c))))))
    }
}
        ...
        x * (std::f64::consts::FRAC_2_SQRT_PI
            - x * (1.0000000000000002
                + x * (1.1514967181784756
                    + x * (5.768_900_120_887_374E-1
                        + x * (1.406_918_874_460_965E-1 + 1.4069285713634565E-2 * x))))
                / (1.0
                    + x * (1.9037494962421563
                        + x * (1.5089908593742723
                            + x * (6.248_608_165_864_026E-1
                ...
                ds = if x < -190.0 {
                    v * householder4_factor(
                        ...
                        ((b_h2 * (b_h3 - 0.5)) - (b_h2 - 2.0 / s) * 2.0 * c)
                            - (bpob
                                * (sq_bpob
                                    * (6.0 + lambda * (22.0 + lambda * (36.0 + lambda * 24.0)))
                                    - (bppob * (12.0 + 6.0 * mu)))
                                - bppob * 3.0 * ot_lambda
